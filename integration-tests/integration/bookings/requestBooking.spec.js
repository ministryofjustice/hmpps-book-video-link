...
context('A user can request a booking', () => {
  ...
  it('A user with multiple preferred courts can request a video link booking for a prisoner who is not in prison', () => {
    ...
    selectCourtPage.preStartEndTime().contains('09:45 to 10:00')
    selectCourtPage.postStartEndTime().contains('11:00 to 11:15')

    const selectCourtForm = selectCourtPage.form()
    selectCourtForm.hearingLocation().select('ABDRCT')
    ...
    confirmationPage.preStartEndTime().contains('09:45 to 10:00')
    confirmationPage.postStartEndTime().contains('11:00 to 11:15')
  ...
  it('A user with a single preferred courts can request a video link booking for a prisoner who is not in prison', () => {
